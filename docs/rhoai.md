...
3) Access the `workbench` named `chatbot-rolling-2025040903-notebook`.
...
5) In the terminal, run `cd chatbot-rolling-2025040903` to navigate to your sample app's directory.
